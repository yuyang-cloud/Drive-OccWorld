...
## 📢 News
- `[2026-1-31]` Our folow work [IR-WM](https://arxiv.org/abs/2510.16729) is accepted by ICRA 2026! Please see the [`ir-wm`](https://github.com/yuyang-cloud/Drive-OccWorld/tree/ir-wm) branch for more details.u
